...
class FindRepeating(PromptBase):
    ...
    Used with website content that is:
...
"""
    ...
    def set_type(self, selector_type: str):
        """
        Initialize the FindRepeating class with a specific selector type.
        """
    ...
    def set_specialization(self, specialization: str):
        """
        Set the specialization for the FindRepeating class.
        This can be used to customize the prompt for specific scraping tasks.
        """
    ...
    def set_repeating_block(self, repeating_block: str):
        ...
        This is the main element that contains all the repetitive patterns in the HTML.
        """
        repeating_block = repeating_block.strip()
        if not repeating_block:
            raise ValueError("repeating_block cannot be empty")
    ...
    def set_required_fields(self, required_fields: list[str]):
        ...
        These fields must be present in the generated JSON schema.
        """
    ...
    def set_optional_fields(self, optional_fields: list[str]):
        ...
        These fields may be present in the generated JSON schema, but only if present and seperable.
        """
    ...
    def build_prompt(self) -> str:
        ...
        specialization = self.specialization or "You specialize in generating JSON schemas for web scraping."
